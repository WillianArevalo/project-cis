<div class="w-full">
    ...
    <div class="relative">
        ...
        <ul
            ...
            @if (count($options) === 0)
                <li
                    class="itemOption pointer-events-none rounded-lg px-4 py-2.5 text-sm text-zinc-900 dark:text-white dark:hover:bg-zinc-900">
                    No hay opciones disponibles
                </li>
            @else
                @foreach ($options as $value => $label)
                    <li class="itemOption cursor-default truncate rounded-lg px-4 py-2.5 text-sm text-zinc-900 hover:bg-zinc-100 dark:text-white dark:hover:bg-zinc-900"
