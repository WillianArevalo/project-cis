...
<head>
    ...
    <title>CIS | Verificar correo</title>
</head>
...
<body>
    ...
    <h1 style="text-align:center; font-size:1.5rem; font-weight:bold; color:#333; margin-top:10px;">Verificar correo</h1>
    <p style="text-align:center; font-size:1rem; color:#666; margin-top:5px;">
        Hola {{ $name }}, ingresa al siguiente enlace para verificar tu correo
    </p>
